        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "0800", 101, 1, "Intro to Web Development" },
                    { 3, 3, "0800", 102, 1, "Intro to MERN" },
                    { 4, 4, "0800", 103, 1, "Intro to .NET MVC Core" },
                    { 5, 3, "0800", 104, 2, "Intro to Web Development II" },
                    { 6, 1, "0800", 105, 2, "Intro to JavaScript" },
                    { 7, 1, "0800", 106, 3, "Intro to Python" },
                    { 8, 1, "0800", 107, 4, "Intro to IT Administration " },
                    { 9, 2, "0800", 108, 5, "Intro to AI" },
                    { 10, 2, "0800", 109, 5, "Intro to Cyber Security" }
                });

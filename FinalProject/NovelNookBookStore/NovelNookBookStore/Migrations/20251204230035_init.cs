...
namespace NovelNookBookStore.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SaleId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SaleItemName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Sales",
                columns: new[] { "SaleId", "ImageUrl", "IsOnSale", "SaleDescription", "SaleItemName", "SalePrice" },
                values: new object[,]
                {
                    { 1, "/Images/Wish-you-were-here.jpg", true, "Hard Cover - Gently used book. No marking or tears.", "Wish you were here", 9.99m },
                    { 2, "/Images/Atlas-Heart.jpg", true, "Hard Cover - Brand New-take a journey into your heart", "Atlas of the Heart", 14.99m },
                    { 3, "/Images/sisters-book.jpg", true, "Hard Cover - Like New- floor model book", "Sisters", 7.99m },
                    { 4, "/Images/goosebumps.jpg", true, "Soft Cover - Used-may contain a couple marks or creases, nothing obstructive", "Goosebumps", 4.99m },
                    { 5, "/Images/court-silver-flames.jpg", true, "Hard Cover - New - floor model book", "A Court of Silver Flames", 15.99m },
                    { 6, "Images/Book-Thumb.jpg", true, "6 pack. Variety of different stones. Easily hold your book open with these beautiful stone-crafted thumb page openers", "Thumb Book Holder", 30.99m },
                    { 7, "/Images/Hungry-Caterpillar.jpg", true, "Hard Cover- Like new", "The Very Hungry Catepillar", 6.99m },
                    { 8, "/Images/Outsiders-Book.jpg", true, "Soft Cover -  Good condition - no creases, tears, or highlighting", "Outsiders", 6.99m },
                    { 9, "/Images/James-Giant-Peach.jpg", true, "Soft Cover - New - Classic", "James and the Giant Peach", 5.99m },
                    { 10, "/Images/Book-Wreath.jpg", true, "Beautiful hand crafted wreath made form recycled book pages", "Book Wreath", 39.99m }
                });
